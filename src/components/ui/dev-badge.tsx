...
export function DevBadge() {
  ...
  return (
    <div
      className="fixed bottom-2 left-2 z-50 flex items-center gap-1.5 rounded-full bg-amber-500/90 px-2.5 py-1 text-xs font-medium text-amber-950 shadow-lg backdrop-blur-sm"
