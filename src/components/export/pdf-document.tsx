...
Font.register({
	...
	fonts: [
		...
		{
			src: "https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_nVMrMxCp50SjIw2boKoduKmMEVuGKYAZ9hjp-Ek-_EeA.woff",
			fontWeight: 600,
		},
		{
...
export function PDFDocument({ resume }: PDFDocumentProps) {
	...
	const renderEducation = (section: ResumeSection) => {
		...
		return (
			<View style={styles.section}>
				<Text style={styles.sectionTitle}>
					{section.content.title || "Education"}
				</Text>
				{education.map((edu) => (
	...
	const renderCertifications = (section: ResumeSection) => {
		...
		return (
			<View style={styles.section}>
				<Text style={styles.sectionTitle}>
					{section.content.title || "Certifications"}
				</Text>
				{certs.map((cert) => (
	...
	const renderLanguages = (section: ResumeSection) => {
		...
		return (
			<View style={styles.section}>
				<Text style={styles.sectionTitle}>
					{section.content.title || "Languages"}
				</Text>
				<View style={styles.skillTags}>
					{languages.map((lang) => (
