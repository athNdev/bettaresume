...
import { authFeatures, isCognitoConfigured } from '@/config/auth.config';
import { 
  FileText, 
  Loader2, 
  Mail, 
...
export default function LoginPage() {
  ...
  const { login, isLoading, error, clearError, loginAsDemo, signInWithGoogle } = useAuthStore();
            ...
            {inDevMode && (
              <Alert className="bg-amber-500/10 border-amber-500/30">
                ...
                <AlertDescription className="text-sm">
                  Running in demo mode. Any email/password will work.
                </AlertDescription>
              </Alert>
            )}
