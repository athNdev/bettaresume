...
export const resumes = sqliteTable('Resume', {
  ...
  variationType: text('variationType').notNull().default('base'),
...
export const resumesRelations = relations(resumes, ({ one, many }) => ({
  ...
  baseResume: one(resumes, { fields: [resumes.baseResumeId], references: [resumes.id], relationName: 'ResumeVariations' }),
...
export const sectionsRelations = relations(sections, ({ one }) => ({
  resume: one(resumes, { fields: [sections.resumeId], references: [resumes.id] }),
}));
