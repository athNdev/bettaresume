...
description: Each template has a distinct style suited for different industries and preferences.
---
...
| If you're applying to... | Consider... |
|--------------------------|-------------|
| FAANG / Big Tech | Modern, Professional |
| Startup | Minimal, Creative |
| Finance / Consulting | Classic, Executive |
| Design Agency | Creative, Modern |
| Government / Enterprise | Classic, Professional |
