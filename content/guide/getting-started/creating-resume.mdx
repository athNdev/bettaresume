...
description: Getting started with Betta Resume is simple and straightforward.
---
...
When you create a new resume, it comes pre-configured with:

- **Personal Info** — Your contact details and professional identity
...
- **Save frequently** — click "Save Changes" after editing each section
